...
def secret_assert(app_name):
    ...
    if real_secret == received_secret:
        ...
        if ENV == "development":
            ...
            call(["ssh","deploy@altlab-itw", "docker", "pull", "docker.pkg.github.com/ualbertaaltlab/hellotest/hellotest:latest","&&", "docker", "run", "--rm","--name=hellotest", "-d", "-p", "5000:5000", "docker.pkg.github.com/ualbertaaltlab/hellotest/hellotest"])
